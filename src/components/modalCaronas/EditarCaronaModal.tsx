// src/components/EditarCaronaModal.tsx
...
export default function EditarCaronaModal({
  isOpen,
  onClose,
  onSalvar,
  carona,
}: EditarCaronaModalProps) {
  ...
  useEffect(() => {
    if (carona) {
      setForm({
        ...
        acessibilidadeId: carona.acessibilidade?.id || 1,
      });
    }
  }, [carona]);
